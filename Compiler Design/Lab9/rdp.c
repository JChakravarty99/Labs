...
void statement_list(){
	s=getnextToken(fa);
	if(s.lexeme[0]=='i'&&s.lexeme[1]=='d'&&s.lexeme[2]==' '|| !strcmp(s.lexeme,"for") || !strcmp(s.lexeme,"while") || !strcmp(s.lexeme,"if") ){
		sanitize(s,fa);
		statement();
		statement_list();
	}
...
void relop(){
	s=getnextToken(fa); printtok(s);
	if(!strcmp(s.lexeme,"==") || !strcmp(s.lexeme,"!=") || !
	strcmp(s.lexeme,"<=") || !strcmp(s.lexeme,">=") || !strcmp(s.lexeme,"<") || !strcmp(s.lexeme,">") ){
		return;
	}
	else{
